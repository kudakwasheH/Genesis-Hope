...
<div class="space-y-8 max-w-2xl mx-auto">
    ...
    <div class="bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-3xl p-8 shadow-sm">
        <h3 class="text-xl font-bold text-slate-900 dark:text-white border-b border-slate-50 dark:border-slate-700 pb-3 mb-6">Create Service Offering</h3>
        ...
        <form action="{{ route('admin.services.store') }}" method="POST" class="space-y-6">
            ...
            <div class="space-y-2">
                ...
                <input type="text" name="name" id="name" required value="{{ old('name') }}" placeholder="E.g. Immunization & Vaccines"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <input type="number" name="duration" id="duration" required value="{{ old('duration', 30) }}" placeholder="30" min="5"
                           class="w-full rounded-2xl border-slate-200 dark:border-slate-600 dark:bg-slate-900 focus:border-teal-500 focus:ring focus:ring-teal-200 dark:text-white text-sm px-4 py-3 bg-slate-50">
                ...
                <div class="space-y-2">
                    ...
                    <input type="number" name="price" id="price" required value="{{ old('price') }}" placeholder="25.00" step="0.01" min="0"
                           class="w-full rounded-2xl border-slate-200 dark:border-slate-600 dark:bg-slate-900 focus:border-teal-500 focus:ring focus:ring-teal-200 dark:text-white text-sm px-4 py-3 bg-slate-50">
            ...
            <div class="space-y-2">
                ...
                <textarea name="description" id="description" rows="5" required placeholder="Describe the care details, target group, and what to expect during consult..."
                          class="w-full rounded-2xl border-slate-200 dark:border-slate-600 dark:bg-slate-900 focus:border-teal-500 focus:ring focus:ring-teal-200 dark:text-white text-sm px-4 py-3 bg-slate-50">{{ old('description') }}</textarea>
